...
Tema.ui = (function () {
  ...
  const browseShell = () =>
    ...
    "</div></div></section>" +
    '<div class="max-w-6xl mx-auto px-6 py-10 flex gap-8 items-start">' +
    '<aside class="w-52 shrink-0 max-md:hidden">' +
    '<h3 id="cats-title" class="text-xs font-bold uppercase tracking-widest text-ink/60 mb-4"></h3>' +
    '<form id="cats" class="flex flex-col gap-2.5"></form></aside>' +
    ...
    '<span id="m-file" class="flex-1 min-w-0 truncate font-mono text-[11px] text-ink/60"></span>' +
